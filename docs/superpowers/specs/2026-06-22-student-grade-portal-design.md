...
> ครูพิมพ์ **ตัวเลข (คะแนนของชิ้นงาน)** ลงเซลล์เป็นบันทึกส่วนตัวได้ — ระบบจะถือว่า "ส่งแล้ว" (✓)
> และ **ซ่อนตัวเลขเสมอ** (ไม่ส่งค่าคะแนนออกไปใน payload) นักเรียนเห็นแค่สถานะส่ง/ไม่ส่งตาม default
> ส่วนคะแนนที่อยากให้นักเรียนเห็น (ผ่านบัตรขูด) ให้ใส่ในแท็บ `Exams`
